...
//        public async Task<AuthResponseDto> RegisterAsync(RegisterDto dto)
//        {
//            // 1. Basic role validation (optional safeguard)
//            var role = dto.Role?.Trim();
//            if (role != "Customer" && role != "RestaurantOwner")
//                role = "Customer"; // fallback

//            // 2. Create and save new Customer or RestaurantOwner
//            if (role == "Customer")
//            {
//                var customer = new Customer
//                {
...
//                    Role = customer.Role,
//                    Token = GenerateToken(customer.Email!, customer.Name!, customer.Role)
//                };
//            }
//            else if (role == "RestaurantOwner")
//            {
...
//                    Role = restaurant.Role,
//                    Token = GenerateToken(restaurant.ContactEmail!, restaurant.Name!, restaurant.Role)
//                };
//            }
